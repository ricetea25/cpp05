...
/*   Updated: 2025/06/25 03:32:54 by rteoh            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const std::string &n, int gs, int ge): name(n), isSigned(false), gradeSign(gs), gradeExe(ge)
{
...
const char* Form::NotExcecutedException::what() const throw()
{
	return "Form Grade too low!";
}
